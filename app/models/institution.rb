class Institution < ActiveRecord::Base
  ...
  def monthly_breakdown
    ...
    if self.name == 'APTrust'
      monthly_data.push(GenericFile.created_before('2018-03-1 00:00:00 -0000').created_after('2018-02-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2018-02-1 00:00:00 -0000').created_after('2018-01-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2018-01-1 00:00:00 -0000').created_after('2017-12-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2017-12-1 00:00:00 -0000').created_after('2017-11-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2017-11-1 00:00:00 -0000').created_after('2017-10-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2017-10-1 00:00:00 -0000').created_after('2017-09-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2017-09-1 00:00:00 -0000').created_after('2017-08-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2017-08-1 00:00:00 -0000').created_after('2017-07-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2017-07-1 00:00:00 -0000').created_after('2017-06-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2017-06-1 00:00:00 -0000').created_after('2017-05-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2017-05-1 00:00:00 -0000').created_after('2017-04-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2017-04-1 00:00:00 -0000').created_after('2017-03-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2017-03-1 00:00:00 -0000').created_after('2017-02-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2017-02-1 00:00:00 -0000').created_after('2017-01-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2017-01-1 00:00:00 -0000').created_after('2016-12-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2016-12-1 00:00:00 -0000').created_after('2016-11-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2016-11-1 00:00:00 -0000').created_after('2016-10-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2016-10-1 00:00:00 -0000').created_after('2016-09-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2016-09-1 00:00:00 -0000').created_after('2016-08-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2016-08-1 00:00:00 -0000').created_after('2016-07-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2016-07-1 00:00:00 -0000').created_after('2016-06-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2016-06-1 00:00:00 -0000').created_after('2016-05-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2016-05-1 00:00:00 -0000').created_after('2016-04-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2016-04-1 00:00:00 -0000').created_after('2016-03-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2016-03-1 00:00:00 -0000').created_after('2016-02-1 00:00:00 -0000').sum(:size) )
      monthly_data.push(GenericFile.created_before('2016-02-1 00:00:00 -0000').created_after('2016-01-1 00:00:00 -0000').sum(:size) )
    else
