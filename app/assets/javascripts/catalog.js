function configureDropDownLists() {
    ...
    var io_options = ['Object Identifier', 'Alternate Identifier', 'Bag Group Identifier', 'Bag Name', 'Title', 'Source Organization', 'Internal Sender Identifier', 'Internal Sender Description'];
