class NotificationMailer < ApplicationMailer
  ...
  def failed_fixity_notification(event, email_log)
    ...
    email_log.email_text = "Admin Users at #{@event_institution.name}, This email notification is to inform you that one of your files failed a fixity check. The associated event is #{@event.identifier}. Please contact the APTrust team by replying to this email if you have any questions."
    email_log.save!
