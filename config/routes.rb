Rails.application.routes.draw do
  ...
  resources :generic_files, only: [:show, :update, :destroy], format: [:html], defaults: { format: :html }, param: :generic_file_identifier, generic_file_identifier: file_ptrn, path: 'files'
