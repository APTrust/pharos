  ...
  describe 'GET #api_index' do
    ...
    describe 'for an admin user' do
      ...
      it 'returns the correct next and previous links' do
        ...
        assigns(:next).should == 'http://test.host/member-api/v1/objects.json/?page=3&per_page=2&updated_since=2014-06-03T15:28:39+00:00'
        assigns(:previous).should == 'http://test.host/member-api/v1/objects.json/?page=1&per_page=2&updated_since=2014-06-03T15:28:39+00:00'
      end
    end
