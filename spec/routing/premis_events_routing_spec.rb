...
describe 'Routes for Events' do
  ...
  it 'has a route to create events for a generic file' do
    expect(post: 'events/apt.org%2F123%2Fdata%2Ffile.pdf')
        .to(route_to(controller: 'premis_events', action: 'create', file_identifier: 'apt.org/123/data/file.pdf'))
  end
  ...
  it 'has a route to create events for an intellectual object' do
    expect(post: 'events/apt.org%2F123')
        .to(route_to(controller: 'premis_events', action: 'create', object_identifier: 'apt.org/123'))
  end
