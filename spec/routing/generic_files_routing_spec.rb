...
describe 'Routing' do
  ...
  it 'should route to update when PATCH /files/apt.org/123/data/filename.xml' do
    expect(patch: '/api/v2/files/apt.org%2F123%2Fdata%2Ffilename.xml/').to route_to(controller: 'generic_files', action: 'update', generic_file_identifier: 'apt.org/123/data/filename.xml')
  end
end
