...
RSpec.describe MemberInstitution, :type => :model do
  subject { FactoryGirl.build(:member_institution) }
  ...
  describe '#name_is_unique' do
    it 'should validate uniqueness of the name' do
      one = FactoryGirl.create(:member_institution, name: 'test')
      two = FactoryGirl.build(:member_institution, name: 'test')
  ...
  describe '#identifier_is_unique' do
    it 'should validate uniqueness of the identifier' do
      one = FactoryGirl.create(:member_institution, identifier: 'test.edu')
      two = FactoryGirl.build(:member_institution, identifier: 'test.edu')
      two.should_not be_valid
  ...
  describe '#find_by_identifier' do
    it 'should validate uniqueness of the identifier' do
      one = FactoryGirl.create(:member_institution, identifier: 'test.edu')
      two = FactoryGirl.create(:member_institution, identifier: 'kollege.edu')
  ...
  describe 'a saved instance' do
    ...
    describe 'with an associated subscription institution' do
      let!(:sub_inst) { FactoryGirl.create(:subscription_institution, member_institution_id: subject.id) }
