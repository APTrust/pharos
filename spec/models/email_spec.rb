...
RSpec.describe Email, type: :model do
  ...
  it 'validates that a fixity check email has an event identifier and nil work item id' do
    subject = FactoryBot.build(:fixity_email, email_type: 'fixity', item_id: 105, event_identifier: nil)
  ...
  it 'validates that a restoration email has an item id and nil event identifier' do
    subject = FactoryBot.build(:fixity_email, email_type: 'restoration', item_id: nil, event_identifier: '1234-5678')
    subject.should_not be_valid
